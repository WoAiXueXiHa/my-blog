...
series: ["数据结构基础"]
featured: false
summary: "本文深入解析了链表的核心概念与常见操作，重点剖析了指针操作中的典型错误（如丢失后继节点、忘记更新头节点），并通过快慢指针法详细讲解了环形链表的检测与入口定位问题。"
seriesOrder: 1
related: []
---
...
![链表和数组内存差异对比](20260712151228063.png)
...
```
![链表插入操作示意](20260712202224403.png)
...
```
![链表删除操作示意](20260712202246950.png)
...
![环形链表入口距离模型](20260712172416416.png)
...
#### 1. 插入节点
假设当前结构：
![双向链表初始结构](20260712185010633.png)

现在需要在 A 之后插入新节点 X：
![双向链表插入新节点](20260712185123476.png)
...
现在来看一道力扣题目：[LeetCode 146 — LRU 缓存](https://leetcode.cn/problems/lru-cache/)
